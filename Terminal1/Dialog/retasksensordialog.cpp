...
void RetaskSensorDialog::accept()
{
    ...
    if(!mac.isEmpty()){
        ...
        if(f1 < 2 && func1 != f1) settings.setValue("func1Retask", func1);
        else settings.setValue("func1Retask", "");
        if(f2 < 2 && func2 != f2) settings.setValue("func2Retask", func2);
        else settings.setValue("func2Retask", "");
        if(f3 < 2 && func3 != f3) settings.setValue("func3Retask", func3);
